...
cp "$workdir/Paperclip/assembly/target/paperclip-${mcver}.jar" "$basedir/log4j-tuinity-paperclip.jar"

echo ""
echo ""
echo ""
echo "Build success!"
echo "Copied final jar to $(cd "$basedir" && pwd -P)/log4j-tuinity-paperclip.jar"
) || exit 1
